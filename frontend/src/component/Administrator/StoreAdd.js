...
import mystyle from './StoreAdd.module.css';
...
const StoreAdd = () => {
    ...
    const getData = () => {
        ...
        axios.post("http://localhost:5000/storesignupdata", { sname: name, semail: email, saddress: address, spass: pass }).then((success) => {
            console.log(success)
        }).catch((error) => {
            console.log(error)
        })
