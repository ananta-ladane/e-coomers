        ...
        if (!role) {
            ...
            if (role === "user") {
                ...
                if (!name || !email || !pass) {
                    ...
                    axios.post("http://localhost:5000/userlogin", { uname: name, uemail: email, upass: pass })
                        .then((success) => {
                            console.log(success)
                            ...
                            if (success.data.result.length == 0) {
                                ...
                                const user = success.data.result[0].Uid;
                                console.log(user)
                                dispatch(actions.userData({ userid: user }));
                                navigate("/userdash")
                ...
                setVstore(sdata.find((s) => { return s.sname === name && s.semail === email && s.spass === pass }))
                ...
                setVadmin(addata.find((a) => { return a.Name === name && a.Email === email && a.Password === pass }))
